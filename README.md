...
Dataset: [SFLS-Q on Kaggle](https://www.kaggle.com/datasets/taihongyang59/quantitative-simulated-forward-looking-sonar/data)

<p align="center">
  <img src="https://github.com/yangtaihong59/Rethink_Acoustic_Image_Enhancement/releases/download/gif/SFLS_compact.gif" width="64%" alt="Compact animated preview of SFLS dataset" />
</p>

### Forward-looking Sonar

Watch on YouTube: [FLS Demo](https://youtu.be/CkXvV9udJZE) 

<p align="center">
  <img src="Sample/MDD/origin/0001_sort.jpg" width="22%" alt="Forward-looking sonar input" />
  <img src="Sample/MDD/denoise/KDLAE-T/0001_sort.jpg" width="22%" alt="Forward-looking sonar denoised by KDLAE-T" />
  <img src="Sample/MDD/origin/0005_sort.jpg" width="22%" alt="Forward-looking sonar input sample 2" />
  <img src="Sample/MDD/denoise/KDLAE-T/0005_sort.jpg" width="22%" alt="Forward-looking sonar denoised by KDLAE-T sample 2" />
</p>
<p align="center">
  <sub>From left to right: sample A input, sample A KDLAE-T output, sample B input, sample B KDLAE-T output.</sub>
</p>

### Medical Ultrasound

Watch on YouTube: [Ultrasound Demo](https://youtu.be/uBQoOC9qfEc)

<p align="center">
  <img src="Sample/CAMUS/origin/0001_4__00.png" width="22%" alt="Ultrasound input sample 1" />
  <img src="Sample/CAMUS/denoise/KDLAE-T/0001_4__00.png" width="22%" alt="Ultrasound denoised by KDLAE-T sample 1" />
  <img src="Sample/CAMUS/origin/0001_4__10.png" width="22%" alt="Ultrasound input sample 2" />
  <img src="Sample/CAMUS/denoise/KDLAE-T/0001_4__10.png" width="22%" alt="Ultrasound denoised by KDLAE-T sample 2" />
</p>
<p align="center">
  <sub>From left to right: sample A input, sample A KDLAE-T output, sample B input, sample B KDLAE-T output.</sub>
</p>

The acoustic imaging simulation tools will be released later as a component of another larger project, but this will take some time.
...
#### Run in Google Colab for a Quick Demo (Recommended)
...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| KDLAE-T        | [KDLAE_T.pth](https://github.com/yangtaihong59/Rethink_Acoustic_Image_Enhancement/releases/download/weight/KDLAE_T.pth)                                           | Teacher denoising model $L1_{Shadow}$, supports adjustable denoising rate |
| KDLAE-T-L2Dice | [KDLAE_T_L2Dice.pth](https://github.com/yangtaihong59/Rethink_Acoustic_Image_Enhancement/releases/download/weight/KDLAE_T_L2Dice.pth) | Teacher denoising model $L2_{Dice}$, supports adjustable denoising rate |
